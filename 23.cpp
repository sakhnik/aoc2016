...
int main()
{
	const char *const test1 =
		...
		"jnz a 2\n"
		"dec a\n";
	assert(42 == Solve(istringstream(test1), {0,0,0,0}));
	...
	const char *const test2 =
		...
		"dec a\n"
		"dec a\n";
	assert(3 == Solve(istringstream(test2), {0,0,0,0}));

	cout << Solve(ifstream("23.txt"), {7,0,0,0}) << endl;
	cout << Solve(ifstream("23.txt"), {12,0,0,0}) << endl;
	return 0;
}
