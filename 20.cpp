...
int main()
{
	assert(3 == Solve(istringstream("5-8\n0-2\n4-7")));
	cout << Solve(ifstream("20.txt")) << endl;

	assert(2 == Solve2(istringstream("5-8\n0-2\n4-7"), 9));
	cout << Solve2(ifstream("20.txt"), numeric_limits<uint32_t>::max()) << endl;
	return 0;
}
