...
int main()
{
	assert(UP | DOWN | LEFT == GetDoors("hijkl"));
	assert(UP | LEFT | RIGHT == GetDoors("hijklD"));
	assert(RIGHT == GetDoors("hijklDU"));

	assert("DDRRRD" == Solve("ihgpwlah"));
	assert("DDUDRLRRUDRD" == Solve("kglvqrro"));
